...
{
    static readonly ILogger logger = LogFactory.GetLogger(typeof(LobbyRoomPlayer));
    ...
    public void Start()
    {
        if (NetworkManager.singleton is LobbyRoomManager room)
        {
    ...
    {
        if (NetworkClient.active && NetworkManager.singleton is LobbyRoomManager room)
        {
