...
[AddComponentMenu("")]
public class LobbyRoomYonetici : LobbyRoomManager
{
    ...
    public override void OnRoomServerSceneChanged(string sceneName)
    {
        ...
        {
            // Oyuncular game scene sine gelince yapılacaklar
    ...
    public override bool OnRoomServerSceneLoadedForPlayer(NetworkConnection conn, GameObject roomPlayer, GameObject gamePlayer)
    {
        ...
        playerScore.index = roomPlayer.GetComponent<LobbyRoomPlayer>().index;
        return true;
    }
