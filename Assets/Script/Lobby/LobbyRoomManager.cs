...
public class LobbyRoomManager : NetworkManager
{
    public StringVariables playerName;
    public IntVariables playerIcon;
    public IntVariables playerCerceve;
    static readonly ILogger logger = LogFactory.GetLogger(typeof(LobbyRoomManager));
    ...
    public LobbyRoomPlayer roomPlayerPrefab;
    ...
    public List<LobbyRoomPlayer> roomSlots = new List<LobbyRoomPlayer>();
    ...
    //    foreach (LobbyRoomPlayer item in roomSlots)
    //    {
    //        if (item != null)
    //        {
    //            CurrentPlayers++;
    ...
    public override void OnServerReady(NetworkConnection conn)
    {
        ...
        if (conn != null && conn.identity != null)
        {
            ...
            if (roomPlayer != null && roomPlayer.GetComponent<LobbyRoomPlayer>() != null)
    ...
    //    int numberOfReadyPlayers = NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<LobbyRoomPlayer>().readyToBegin);
    ...
    {
        OnRoomClientEnter();
        foreach (LobbyRoomPlayer player in roomSlots)
            if (player != null)
            {
    ...
    public override void OnServerDisconnect(NetworkConnection conn)
    {
        ...
        {
            LobbyRoomPlayer roomPlayer = conn.identity.GetComponent<LobbyRoomPlayer>();
            ...
            {
                roomPlayer = clientOwnedObject.GetComponent<LobbyRoomPlayer>();
                if (roomPlayer != null)
                    roomSlots.Remove(roomPlayer);
            }
        }
        ...
        //{
        //    if (player != null)
        //        player.GetComponent<LobbyRoomPlayer>().readyToBegin = false;
        //}
    ...
    public override void ServerChangeScene(string newSceneName)
    {
        ...
        {
            foreach (LobbyRoomPlayer roomPlayer in roomSlots)
            {
                if (roomPlayer == null)
                    continue;
                ...
                if (NetworkServer.active)
                {
                    ...
                    //roomPlayer.GetComponent<LobbyRoomPlayer>().readyToBegin = false;
